			...
			if($table){
				...
				if($rows == 1){
					...
					if ($_SESSION['user_type'] == 'company') {
						header("location: company_profile.php?user=".$_SESSION['login_user']);
						exit();
					}
					elseif ($_SESSION['user_type'] == 'institute') {
						header("location: institute_profile.php?user=".$_SESSION['login_user']);
						exit();
					}
					else{
