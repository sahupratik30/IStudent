<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		else if (!empty($_POST['user_name']) && $_POST['user_name'] != $_SESSION['user_name']){
			$user_name = $_POST['user_name'];
			$user_name = filter_var($user_name, FILTER_SANITIZE_STRING);
			$query = "update user set user_name='".$user_name."' where id=".$_SESSION['login_user'];
		}
		else if (!empty($_POST['contact']) && $_POST['contact'] != $_SESSION['contact']){
			$contact = $_POST['contact'];
			$query = "update user set contact_no='".$contact."' where id=".$_SESSION['login_user'];
		}
		else if (!empty($_POST['email']) && $_POST['email'] != $_SESSION['email_id']){
			$email = $_POST['email'];
		...
		else if (!empty($_POST['dp_url']) && $_POST['dp_url'] != $_SESSION['dp_url']){
			$dp_url = $_POST['dp_url'];
